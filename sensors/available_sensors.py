...
SENSORS = [
    ...
    JSONSensor(_id="8", name="Bird1 Health", value={"hb": 35, "body_tem": 35}),
    JSONSensor(_id="9", name="Bird2 Health", value={"hb": 35, "body_tem": 35}),
    JSONSensor(_id="10", name="Bird3 Healt", value={"hb": 35, "body_tem": 35}),

    JSONSensor(_id="11", name="Bird1 Coords", value={"lat": 45, "lon": 46}),
    JSONSensor(_id="12", name="Bird2 Coords", value={"lat": 45, "lon": 46}),
    JSONSensor(_id="13", name="Bird3 Coords", value={"lat": 45, "lon": 46}),
